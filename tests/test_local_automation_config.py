...
from app.local_automation_config import get_automation_config
...
class TestGetAutomationConfigTool:
    ...
    async def test_tool_delegates_to_hass_layer(self):
        ...
        with patch("app.local_automation_config.get_automation_config", new=AsyncMock(return_value=mock_config)) as mock_fn:
